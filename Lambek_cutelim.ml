...
module Lambek =
 struct
  ...
  let rec formula_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 = function
  | Atf p -> f p
  | FVf a -> f0 a
  | Top -> f1
  | Bot -> f2
  | Dis (phi, psi) ->
    f3 phi (formula_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 phi) psi
      (formula_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 psi)
  | Con (phi, psi) ->
    f4 phi (formula_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 phi) psi
      (formula_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 psi)
  | One -> f5
  | Fus (phi, psi) ->
    f6 phi (formula_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 phi) psi
      (formula_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 psi)
  | Und (phi, psi) ->
    f7 phi (formula_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 phi) psi
      (formula_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 psi)
  | Ove (phi, psi) ->
    f8 phi (formula_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 phi) psi
      (formula_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 psi)
  ...
  let rec formula_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 = function
  | Atf p -> f p
  | FVf a -> f0 a
  | Top -> f1
  | Bot -> f2
  | Dis (phi, psi) ->
    f3 phi (formula_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 phi) psi
      (formula_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 psi)
  | Con (phi, psi) ->
    f4 phi (formula_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 phi) psi
      (formula_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 psi)
  | One -> f5
  | Fus (phi, psi) ->
    f6 phi (formula_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 phi) psi
      (formula_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 psi)
  | Und (phi, psi) ->
    f7 phi (formula_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 phi) psi
      (formula_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 psi)
  | Ove (phi, psi) ->
    f8 phi (formula_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 phi) psi
      (formula_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 psi)
  ...
  | Coq__UU03a6_ -> f2
  | Smc (x, y) ->
    f3 x (structr_rect f f0 f1 f2 f3 f4 f5 x) y
      (structr_rect f f0 f1 f2 f3 f4 f5 y)
  | Gre (x, y) ->
    f4 x (structr_rect f f0 f1 f2 f3 f4 f5 x) y
      (structr_rect f f0 f1 f2 f3 f4 f5 y)
  | Les (x, y) ->
    f5 x (structr_rect f f0 f1 f2 f3 f4 f5 x) y
      (structr_rect f f0 f1 f2 f3 f4 f5 y)
  ...
  | Coq__UU03a6_ -> f2
  | Smc (x, y) ->
    f3 x (structr_rec f f0 f1 f2 f3 f4 f5 x) y
      (structr_rec f f0 f1 f2 f3 f4 f5 y)
  | Gre (x, y) ->
    f4 x (structr_rec f f0 f1 f2 f3 f4 f5 x) y
      (structr_rec f f0 f1 f2 f3 f4 f5 y)
  | Les (x, y) ->
    f5 x (structr_rec f f0 f1 f2 f3 f4 f5 x) y
      (structr_rec f f0 f1 f2 f3 f4 f5 y)
 end
...
let f_Lambek_log =
  { ipse = Lambek_LOG.ipse; ipse_rect = (fun _ -> Lambek_LOG.ipse_rect);
...
let lambek_log =
  { atm = (fun x -> Lambek.Atf x); fV = (fun x -> Lambek.FVf x); aTMVAR =
    lambek_Atm; fVVAR = lambek_FV }
...
let f_Lambek =
  { ipse = Lambek_STR.ipse; ipse_rect = (fun _ -> Lambek_STR.ipse_rect);
...
let lambek_str =
  { sV = (fun x -> Lambek.SVf x); fS = (fun x -> Lambek.FSf x); sVVAR =
    lambek_SV; fSVAR = lambek_FS; sgnips = Lambek_STR.sgnips }
...
module LambekRules =
 struct
  ...
  let coq_Topl =
    ((Sequent (Lambek.I, (Lambek.SVf "X")))::[]),(Sequent ((Lambek.FSf
      Lambek.Top), (Lambek.SVf "X")))
  ...
  let coq_Conll =
    ((Sequent ((Lambek.FSf (Lambek.FVf "A")), (Lambek.SVf
      "X")))::[]),(Sequent ((Lambek.FSf (Lambek.Con ((Lambek.FVf "A"),
      (Lambek.FVf "B")))), (Lambek.SVf "X")))

  (** val coq_Conlr : (Lambek.formula, Lambek.structr) rule **)

  let coq_Conlr =
    ((Sequent ((Lambek.FSf (Lambek.FVf "B")), (Lambek.SVf
      "X")))::[]),(Sequent ((Lambek.FSf (Lambek.Con ((Lambek.FVf "A"),
      (Lambek.FVf "B")))), (Lambek.SVf "X")))
  ...
  let coq_Conr =
    ((Sequent ((Lambek.SVf "X"), (Lambek.FSf (Lambek.FVf "A"))))::((Sequent
      ((Lambek.SVf "X"), (Lambek.FSf (Lambek.FVf "B"))))::[])),(Sequent
      ((Lambek.SVf "X"), (Lambek.FSf (Lambek.Con ((Lambek.FVf "A"),
      (Lambek.FVf "B"))))))
  ...
  let coq_Disl =
    ((Sequent ((Lambek.FSf (Lambek.FVf "A")), (Lambek.SVf "X")))::((Sequent
      ((Lambek.FSf (Lambek.FVf "B")), (Lambek.SVf "X")))::[])),(Sequent
      ((Lambek.FSf (Lambek.Dis ((Lambek.FVf "A"), (Lambek.FVf "B")))),
      (Lambek.SVf "X")))

  (** val coq_Disrl : (Lambek.formula, Lambek.structr) rule **)

  let coq_Disrl =
    ((Sequent ((Lambek.SVf "X"), (Lambek.FSf (Lambek.FVf
      "A"))))::[]),(Sequent ((Lambek.SVf "X"), (Lambek.FSf (Lambek.Dis
      ((Lambek.FVf "A"), (Lambek.FVf "B"))))))

  (** val coq_Disrr : (Lambek.formula, Lambek.structr) rule **)

  let coq_Disrr =
    ((Sequent ((Lambek.SVf "X"), (Lambek.FSf (Lambek.FVf
      "B"))))::[]),(Sequent ((Lambek.SVf "X"), (Lambek.FSf (Lambek.Dis
      ((Lambek.FVf "A"), (Lambek.FVf "B"))))))

  (** val coq_Onel : (Lambek.formula, Lambek.structr) rule **)

  let coq_Onel =
    ((Sequent (Lambek.Coq__UU03a6_, (Lambek.SVf "X")))::[]),(Sequent
      ((Lambek.FSf Lambek.One), (Lambek.SVf "X")))
  ...
  let coq_Fusl =
    ((Sequent ((Lambek.Smc ((Lambek.FSf (Lambek.FVf "A")), (Lambek.FSf
      (Lambek.FVf "B")))), (Lambek.SVf "X")))::[]),(Sequent ((Lambek.FSf
      (Lambek.Fus ((Lambek.FVf "A"), (Lambek.FVf "B")))), (Lambek.SVf "X")))

  (** val coq_Fusr : (Lambek.formula, Lambek.structr) rule **)

  let coq_Fusr =
    ((Sequent ((Lambek.SVf "X"), (Lambek.FSf (Lambek.FVf "A"))))::((Sequent
      ((Lambek.SVf "Y"), (Lambek.FSf (Lambek.FVf "B"))))::[])),(Sequent
      ((Lambek.Smc ((Lambek.SVf "X"), (Lambek.SVf "Y"))), (Lambek.FSf
      (Lambek.Fus ((Lambek.FVf "A"), (Lambek.FVf "B"))))))

  (** val coq_Undl : (Lambek.formula, Lambek.structr) rule **)

  let coq_Undl =
    ((Sequent ((Lambek.SVf "X"), (Lambek.FSf (Lambek.FVf "A"))))::((Sequent
      ((Lambek.FSf (Lambek.FVf "B")), (Lambek.SVf "Y")))::[])),(Sequent
      ((Lambek.FSf (Lambek.Und ((Lambek.FVf "A"), (Lambek.FVf "B")))),
      (Lambek.Gre ((Lambek.SVf "X"), (Lambek.SVf "Y")))))

  (** val coq_Undr : (Lambek.formula, Lambek.structr) rule **)

  let coq_Undr =
    ((Sequent ((Lambek.SVf "X"), (Lambek.Gre ((Lambek.FSf (Lambek.FVf "A")),
      (Lambek.FSf (Lambek.FVf "B"))))))::[]),(Sequent ((Lambek.SVf "X"),
      (Lambek.FSf (Lambek.Und ((Lambek.FVf "A"), (Lambek.FVf "B"))))))
  ...
  let coq_Ovel =
    ((Sequent ((Lambek.FSf (Lambek.FVf "A")), (Lambek.SVf "X")))::((Sequent
      ((Lambek.SVf "Y"), (Lambek.FSf (Lambek.FVf "B"))))::[])),(Sequent
      ((Lambek.FSf (Lambek.Ove ((Lambek.FVf "A"), (Lambek.FVf "B")))),
      (Lambek.Les ((Lambek.SVf "X"), (Lambek.SVf "Y")))))
  ...
  let _UU03a6_addll =
    ((Sequent ((Lambek.SVf "X"), (Lambek.SVf "Y")))::[]),(Sequent
      ((Lambek.Smc (Lambek.Coq__UU03a6_, (Lambek.SVf "X"))), (Lambek.SVf
      "Y")))
  ...
  let _UU03a6_addlr =
    ((Sequent ((Lambek.SVf "X"), (Lambek.SVf "Y")))::[]),(Sequent
      ((Lambek.Smc ((Lambek.SVf "X"), Lambek.Coq__UU03a6_)), (Lambek.SVf
      "Y")))
  ...
  let _UU03a6_addrl =
    ((Sequent ((Lambek.SVf "X"), (Lambek.SVf "Y")))::[]),(Sequent
      ((Lambek.SVf "X"), (Lambek.Smc (Lambek.Coq__UU03a6_, (Lambek.SVf
      "Y")))))
  ...
  let _UU03a6_addrr =
    ((Sequent ((Lambek.SVf "X"), (Lambek.SVf "Y")))::[]),(Sequent
      ((Lambek.SVf "X"), (Lambek.Smc ((Lambek.SVf "Y"),
      Lambek.Coq__UU03a6_))))

  (** val _UU03a6_delll : (Lambek.formula, Lambek.structr) rule **)

  let _UU03a6_delll =
    ((Sequent ((Lambek.Smc (Lambek.Coq__UU03a6_, (Lambek.SVf "X"))),
      (Lambek.SVf "Y")))::[]),(Sequent ((Lambek.SVf "X"), (Lambek.SVf "Y")))

  (** val _UU03a6_dellr : (Lambek.formula, Lambek.structr) rule **)

  let _UU03a6_dellr =
    ((Sequent ((Lambek.Smc ((Lambek.SVf "X"), Lambek.Coq__UU03a6_)),
      (Lambek.SVf "Y")))::[]),(Sequent ((Lambek.SVf "X"), (Lambek.SVf "Y")))

  (** val _UU03a6_delrl : (Lambek.formula, Lambek.structr) rule **)

  let _UU03a6_delrl =
    ((Sequent ((Lambek.SVf "X"), (Lambek.Smc (Lambek.Coq__UU03a6_,
      (Lambek.SVf "Y")))))::[]),(Sequent ((Lambek.SVf "X"), (Lambek.SVf "Y")))
  ...
  let _UU03a6_delrr =
    ((Sequent ((Lambek.SVf "X"), (Lambek.Smc ((Lambek.SVf "Y"),
      Lambek.Coq__UU03a6_))))::[]),(Sequent ((Lambek.SVf "X"), (Lambek.SVf
      "Y")))
  ...
  let coq_Rlesmr =
    ((Sequent ((Lambek.SVf "X"), (Lambek.Les ((Lambek.SVf "Y"), (Lambek.SVf
      "Z")))))::[]),(Sequent ((Lambek.Smc ((Lambek.SVf "X"), (Lambek.SVf
      "Z"))), (Lambek.SVf "Y")))
  ...
  let coq_Rgesmr =
    ((Sequent ((Lambek.SVf "X"), (Lambek.Gre ((Lambek.SVf "Y"), (Lambek.SVf
      "Z")))))::[]),(Sequent ((Lambek.Smc ((Lambek.SVf "Y"), (Lambek.SVf
      "X"))), (Lambek.SVf "Z")))
  ...
  let coq_Rsmger =
    ((Sequent ((Lambek.SVf "X"), (Lambek.Smc ((Lambek.SVf "Y"), (Lambek.SVf
      "Z")))))::[]),(Sequent ((Lambek.Gre ((Lambek.SVf "Y"), (Lambek.SVf
      "X"))), (Lambek.SVf "Z")))
  ...
  let coq_Rsmler =
    ((Sequent ((Lambek.SVf "X"), (Lambek.Smc ((Lambek.SVf "Y"), (Lambek.SVf
      "Z")))))::[]),(Sequent ((Lambek.Les ((Lambek.SVf "X"), (Lambek.SVf
      "Z"))), (Lambek.SVf "Y")))
 end
...
module LambekBelnap =
 struct
  ...
  let coq_C8_Con_l x y a b ld =
    c8_case_alt_imp_C8_case eqDec_formula f_Lambek_log lambek_log
      eqDec_structr f_Lambek lambek_str lambek_DC x y ((Sequent (x,
      (Lambek.FSf a)))::((Sequent (x, (Lambek.FSf b)))::((Sequent
      ((Lambek.FSf a), y))::[]))) (fun hders ->
      let x0 = fun dC cs ->
        let _,x0 =
          forallT_deriv_cofseqs_iff eqDec_formula f_Lambek_log lambek_log
            eqDec_structr f_Lambek lambek_str dC cs
        in
        x0
      in
      let hders0 =
        x0 lambek_DC ((Sequent (x, (Lambek.FSf a)))::((Sequent (x,
          (Lambek.FSf b)))::((Sequent ((Lambek.FSf a), y))::[]))) hders
      in
      let hders1 =
      ...
      in
      let hders2 =
        forallT_inv_tail (Sequent (x, (Lambek.FSf a))) ((Sequent (x,
          (Lambek.FSf b)))::((Sequent ((Lambek.FSf a), y))::[])) hders0
      in
      let hders3 =
        forallT_inv_tail (Sequent (x, (Lambek.FSf b))) ((Sequent ((Lambek.FSf
          a), y))::[]) hders2
      in
      ...
      deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log lambek_log
        ...
        (cUT_spec eqDec_formula f_Lambek_log lambek_log eqDec_structr
          f_Lambek lambek_str a x y)
        (forallT_deriv_cofseqs eqDec_formula f_Lambek_log lambek_log
          eqDec_structr f_Lambek lambek_str lambek_DC ((Sequent (x,
          (Lambek.FSf a)))::((Sequent ((Lambek.FSf a), y))::[]))
          (ForallT_cons ((Sequent (x, (Lambek.FSf a))), ((Sequent
          ((Lambek.FSf a), y))::[]), hders1, (ForallT_cons ((Sequent
  ...
  let coq_C8_Con_r x y a b ld =
    c8_case_alt_imp_C8_case eqDec_formula f_Lambek_log lambek_log
      ...
      let hders0 =
        x0 lambek_DC ((Sequent (x, (Lambek.FSf a)))::((Sequent (x,
          (Lambek.FSf b)))::((Sequent ((Lambek.FSf b), y))::[]))) hders
      in
      let hders1 =
        forallT_inv_tail (Sequent (x, (Lambek.FSf a))) ((Sequent (x,
          (Lambek.FSf b)))::((Sequent ((Lambek.FSf b), y))::[])) hders0
      in
      let hders2 =
        forallT_inv (Sequent (x, (Lambek.FSf b))) ((Sequent ((Lambek.FSf b),
          y))::[]) hders1
      in
      let hders3 =
        forallT_inv_tail (Sequent (x, (Lambek.FSf b))) ((Sequent ((Lambek.FSf
      ...
      deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log lambek_log
        ...
        (conclRule eqDec_formula f_Lambek_log lambek_log eqDec_structr
          ...
          (cUT eqDec_formula f_Lambek_log lambek_log eqDec_structr f_Lambek
            lambek_str))
        (cUT_spec eqDec_formula f_Lambek_log lambek_log eqDec_structr
          f_Lambek lambek_str b x y)
        (forallT_deriv_cofseqs eqDec_formula f_Lambek_log lambek_log
          eqDec_structr f_Lambek lambek_str lambek_DC ((Sequent (x,
          (Lambek.FSf b)))::((Sequent ((Lambek.FSf b), y))::[]))
          (ForallT_cons ((Sequent (x, (Lambek.FSf b))), ((Sequent
          ((Lambek.FSf b), y))::[]), hders2, (ForallT_cons ((Sequent
  ...
  let coq_C8_Dis_l x y a b ld =
    c8_case_alt_imp_C8_case eqDec_formula f_Lambek_log lambek_log
      eqDec_structr f_Lambek lambek_str lambek_DC x y ((Sequent (x,
      (Lambek.FSf a)))::((Sequent ((Lambek.FSf a), y))::((Sequent
      ((Lambek.FSf b), y))::[]))) (fun hders ->
      let x0 = fun dC cs ->
        let _,x0 =
          forallT_deriv_cofseqs_iff eqDec_formula f_Lambek_log lambek_log
      ...
      in
      let hders0 =
        x0 lambek_DC ((Sequent (x, (Lambek.FSf a)))::((Sequent ((Lambek.FSf
          a), y))::((Sequent ((Lambek.FSf b), y))::[]))) hders
      in
      let hders1 =
      ...
      in
      let hders2 =
        forallT_inv_tail (Sequent (x, (Lambek.FSf a))) ((Sequent ((Lambek.FSf
          a), y))::((Sequent ((Lambek.FSf b), y))::[])) hders0
      in
      let hders3 =
        forallT_inv (Sequent ((Lambek.FSf a), y)) ((Sequent ((Lambek.FSf b),
          y))::[]) hders2
      in
      deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log lambek_log
        eqDec_structr f_Lambek lambek_str lambek_DC
  ...
  let coq_C8_Dis_r x y a b ld =
    c8_case_alt_imp_C8_case eqDec_formula f_Lambek_log lambek_log
      eqDec_structr f_Lambek lambek_str lambek_DC x y ((Sequent (x,
      (Lambek.FSf b)))::((Sequent ((Lambek.FSf a), y))::((Sequent
      ((Lambek.FSf b), y))::[]))) (fun hders ->
      let x0 = fun dC cs ->
        let _,x0 =
          forallT_deriv_cofseqs_iff eqDec_formula f_Lambek_log lambek_log
      ...
      in
      let hders0 =
        x0 lambek_DC ((Sequent (x, (Lambek.FSf b)))::((Sequent ((Lambek.FSf
          a), y))::((Sequent ((Lambek.FSf b), y))::[]))) hders
      in
      let hders1 =
      ...
      in
      let hders3 =
        forallT_inv_tail (Sequent ((Lambek.FSf a), y)) ((Sequent ((Lambek.FSf
          b), y))::[]) hders2
      in
      let hders4 = forallT_inv (Sequent ((Lambek.FSf b), y)) [] hders3 in
      deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log lambek_log
        ...
        (forallT_deriv_cofseqs eqDec_formula f_Lambek_log lambek_log
          ...
          (Lambek.FSf b)))::((Sequent ((Lambek.FSf b), y))::[]))
          (ForallT_cons ((Sequent (x, (Lambek.FSf b))), ((Sequent
          ((Lambek.FSf b), y))::[]), hders1, (ForallT_cons ((Sequent
          ((Lambek.FSf b), y)), [], hders4, ForallT_nil)))))) ld
  ...
  let coq_C8_Fus x1 x2 y a b ld =
    c8_case_alt_imp_C8_case eqDec_formula f_Lambek_log lambek_log
      eqDec_structr f_Lambek lambek_str lambek_DC (Lambek.Smc (x1, x2)) y
      ((Sequent (x1, (Lambek.FSf a)))::((Sequent (x2, (Lambek.FSf
      b)))::((Sequent ((Lambek.Smc ((Lambek.FSf a), (Lambek.FSf b))),
      y))::[]))) (fun hders ->
      let x = fun dC cs ->
        let _,x =
          forallT_deriv_cofseqs_iff eqDec_formula f_Lambek_log lambek_log
      ...
      in
      let hders0 =
        x lambek_DC ((Sequent (x1, (Lambek.FSf a)))::((Sequent (x2,
          (Lambek.FSf b)))::((Sequent ((Lambek.Smc ((Lambek.FSf a),
          (Lambek.FSf b))), y))::[]))) hders
      in
      let hders1 =
      ...
      in
      let hders2 =
        forallT_inv_tail (Sequent (x1, (Lambek.FSf a))) ((Sequent (x2,
          (Lambek.FSf b)))::((Sequent ((Lambek.Smc ((Lambek.FSf a),
          (Lambek.FSf b))), y))::[])) hders0
      in
      let hders3 =
        forallT_inv (Sequent (x2, (Lambek.FSf b))) ((Sequent ((Lambek.Smc
          ((Lambek.FSf a), (Lambek.FSf b))), y))::[]) hders2
      in
      let hders4 =
        forallT_inv_tail (Sequent (x2, (Lambek.FSf b))) ((Sequent
          ((Lambek.Smc ((Lambek.FSf a), (Lambek.FSf b))), y))::[]) hders2
      in
      let hders5 =
        forallT_inv (Sequent ((Lambek.Smc ((Lambek.FSf a), (Lambek.FSf b))),
          y)) [] hders4
      in
      deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log lambek_log
        eqDec_structr f_Lambek lambek_str lambek_DC
        (premsRule eqDec_formula f_Lambek_log lambek_log eqDec_structr
          f_Lambek lambek_str LambekRules.coq_Rgesmr)
        (conclRule eqDec_formula f_Lambek_log lambek_log eqDec_structr
          f_Lambek lambek_str LambekRules.coq_Rgesmr)
          ...
          (map
            (seqSubst eqDec_formula f_Lambek_log lambek_log eqDec_structr
              ...
              (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                ...
                (Sequent ((Lambek.Smc (x1, x2)), y))))
            (premsRule eqDec_formula f_Lambek_log lambek_log eqDec_structr
              f_Lambek lambek_str LambekRules.coq_Rgesmr)) (ForallT_cons
          ((seqSubst eqDec_formula f_Lambek_log lambek_log eqDec_structr
             f_Lambek lambek_str
             (seq_matchsub eqDec_formula f_Lambek_log lambek_log
               eqDec_structr f_Lambek lambek_str
               (conclRule eqDec_formula f_Lambek_log lambek_log eqDec_structr
                 f_Lambek lambek_str LambekRules.coq_Rgesmr) (Sequent
               ((Lambek.Smc (x1, x2)), y))) (Sequent ((Lambek.SVf "X"),
             (Lambek.Gre ((Lambek.SVf "Y"), (Lambek.SVf "Z")))))), [],
          (deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log lambek_log
            eqDec_structr f_Lambek lambek_str lambek_DC
            (premsRule eqDec_formula f_Lambek_log lambek_log eqDec_structr
              f_Lambek lambek_str
            ...
            (conclRule eqDec_formula f_Lambek_log lambek_log eqDec_structr
              ...
              (cUT eqDec_formula f_Lambek_log lambek_log eqDec_structr
                f_Lambek lambek_str))
            (cUT_spec eqDec_formula f_Lambek_log lambek_log eqDec_structr
              f_Lambek lambek_str b x2 (Lambek.Gre (x1, y)))
            (forallT_deriv_cofseqs eqDec_formula f_Lambek_log lambek_log
              eqDec_structr f_Lambek lambek_str lambek_DC ((Sequent (x2,
              (Lambek.FSf b)))::((Sequent ((Lambek.FSf b), (Lambek.Gre (x1,
              y))))::[])) (ForallT_cons ((Sequent (x2, (Lambek.FSf b))),
              ((Sequent ((Lambek.FSf b), (Lambek.Gre (x1, y))))::[]), hders3,
              (ForallT_cons ((Sequent ((Lambek.FSf b), (Lambek.Gre (x1,
              y)))), [],
              (deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log
                ...
                (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                  ...
                  (conclRule eqDec_formula f_Lambek_log lambek_log
                    eqDec_structr f_Lambek lambek_str LambekRules.coq_Rsmgel)
                  (Sequent ((Lambek.FSf b), (Lambek.Gre (x1, y)))))
                (forallT_deriv_cofseqs eqDec_formula f_Lambek_log lambek_log
                  eqDec_structr f_Lambek lambek_str lambek_DC
                  (map
                    (seqSubst eqDec_formula f_Lambek_log lambek_log
                      ...
                      (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                        ...
                        (conclRule eqDec_formula f_Lambek_log lambek_log
                          eqDec_structr f_Lambek lambek_str
                          LambekRules.coq_Rsmgel) (Sequent ((Lambek.FSf b),
                        (Lambek.Gre (x1, y))))))
                    (premsRule eqDec_formula f_Lambek_log lambek_log
                      eqDec_structr f_Lambek lambek_str
                      LambekRules.coq_Rsmgel)) (ForallT_cons
                  ((seqSubst eqDec_formula f_Lambek_log lambek_log
                     eqDec_structr f_Lambek lambek_str
                     (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                       eqDec_structr f_Lambek lambek_str
                       (conclRule eqDec_formula f_Lambek_log lambek_log
                         eqDec_structr f_Lambek lambek_str
                         LambekRules.coq_Rsmgel) (Sequent ((Lambek.FSf b),
                       (Lambek.Gre (x1, y))))) (Sequent ((Lambek.Smc
                     ((Lambek.SVf "X"), (Lambek.SVf "Y"))), (Lambek.SVf
                     "Z")))), [],
                  (deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log
                    lambek_log eqDec_structr f_Lambek lambek_str lambek_DC
                    (premsRule eqDec_formula f_Lambek_log lambek_log
                      eqDec_structr f_Lambek lambek_str
                      LambekRules.coq_Rlesmr)
                    (conclRule eqDec_formula f_Lambek_log lambek_log
                      eqDec_structr f_Lambek lambek_str
                      LambekRules.coq_Rlesmr)
                    (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                      ...
                      (conclRule eqDec_formula f_Lambek_log lambek_log
                        eqDec_structr f_Lambek lambek_str
                        LambekRules.coq_Rlesmr) (Sequent ((Lambek.Smc (x1,
                      (Lambek.FSf b))), y)))
                      ...
                      (map
                        (seqSubst eqDec_formula f_Lambek_log lambek_log
                          ...
                          (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                            ...
                            (conclRule eqDec_formula f_Lambek_log lambek_log
                              eqDec_structr f_Lambek lambek_str
                              LambekRules.coq_Rlesmr) (Sequent ((Lambek.Smc
                            (x1, (Lambek.FSf b))), y))))
                        (premsRule eqDec_formula f_Lambek_log lambek_log
                          eqDec_structr f_Lambek lambek_str
                      ...
                      ((seqSubst eqDec_formula f_Lambek_log lambek_log
                         ...
                         (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                           ...
                           (conclRule eqDec_formula f_Lambek_log lambek_log
                             eqDec_structr f_Lambek lambek_str
                             LambekRules.coq_Rlesmr) (Sequent ((Lambek.Smc
                           (x1, (Lambek.FSf b))), y))) (Sequent ((Lambek.SVf
                         "X"), (Lambek.Les ((Lambek.SVf "Y"), (Lambek.SVf
                         "Z")))))), [],
                      (deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log
                        ...
                        (premsRule eqDec_formula f_Lambek_log lambek_log
                          eqDec_structr f_Lambek lambek_str
                          (cUT eqDec_formula f_Lambek_log lambek_log
                            eqDec_structr f_Lambek lambek_str))
                        (conclRule eqDec_formula f_Lambek_log lambek_log
                          eqDec_structr f_Lambek lambek_str
                          (cUT eqDec_formula f_Lambek_log lambek_log
                            eqDec_structr f_Lambek lambek_str))
                        (cUT_spec eqDec_formula f_Lambek_log lambek_log
                          eqDec_structr f_Lambek lambek_str a x1 (Lambek.Les
                          (y, (Lambek.FSf b))))
                        (forallT_deriv_cofseqs eqDec_formula f_Lambek_log
                          lambek_log eqDec_structr f_Lambek lambek_str
                          lambek_DC ((Sequent (x1, (Lambek.FSf
                          a)))::((Sequent ((Lambek.FSf a), (Lambek.Les (y,
                          (Lambek.FSf b)))))::[])) (ForallT_cons ((Sequent
                          (x1, (Lambek.FSf a))), ((Sequent ((Lambek.FSf a),
                          (Lambek.Les (y, (Lambek.FSf b)))))::[]), hders1,
                          (ForallT_cons ((Sequent ((Lambek.FSf a),
                          (Lambek.Les (y, (Lambek.FSf b))))), [],
                          (deriv_cofseq_rule_bw_inDC eqDec_formula
                            f_Lambek_log lambek_log eqDec_structr f_Lambek
                            lambek_str lambek_DC
                            (premsRule eqDec_formula f_Lambek_log lambek_log
                              eqDec_structr f_Lambek lambek_str
                              LambekRules.coq_Rsmlel)
                            (conclRule eqDec_formula f_Lambek_log lambek_log
                              eqDec_structr f_Lambek lambek_str
                              LambekRules.coq_Rsmlel)
                            (seq_matchsub eqDec_formula f_Lambek_log
                              lambek_log eqDec_structr f_Lambek lambek_str
                              (conclRule eqDec_formula f_Lambek_log
                                lambek_log eqDec_structr f_Lambek lambek_str
                                LambekRules.coq_Rsmlel) (Sequent ((Lambek.FSf
                              a), (Lambek.Les (y, (Lambek.FSf b))))))
                            (forallT_deriv_cofseqs eqDec_formula f_Lambek_log
                              lambek_log eqDec_structr f_Lambek lambek_str
                              lambek_DC
                              (map
                                (seqSubst eqDec_formula f_Lambek_log
                                  ...
                                  (seq_matchsub eqDec_formula f_Lambek_log
                                    ...
                                    (Sequent ((Lambek.FSf a), (Lambek.Les (y,
                                    (Lambek.FSf b)))))))
                                (premsRule eqDec_formula f_Lambek_log
                                  lambek_log eqDec_structr f_Lambek
                                  lambek_str LambekRules.coq_Rsmlel))
                              (ForallT_cons
                              ((seqSubst eqDec_formula f_Lambek_log
                                 ...
                                 (seq_matchsub eqDec_formula f_Lambek_log
                                   ...
                                   (conclRule eqDec_formula f_Lambek_log
                                     ...
                                     lambek_str LambekRules.coq_Rsmlel)
                                   (Sequent ((Lambek.FSf a), (Lambek.Les (y,
                                   (Lambek.FSf b)))))) (Sequent ((Lambek.Smc
                                 ((Lambek.SVf "X"), (Lambek.SVf "Y"))),
                                 (Lambek.SVf "Z")))), [], hders5,
                              ForallT_nil)))), ForallT_nil)))))),
  ...
  let coq_C8_Und x y1 y2 a b ld =
    c8_case_alt_imp_C8_case eqDec_formula f_Lambek_log lambek_log
      eqDec_structr f_Lambek lambek_str lambek_DC x (Lambek.Gre (y1, y2))
      ((Sequent (x, (Lambek.Gre ((Lambek.FSf a), (Lambek.FSf
      ...
      in
      let hders1 =
        forallT_inv (Sequent (x, (Lambek.Gre ((Lambek.FSf a), (Lambek.FSf
          b))))) ((Sequent (y1, (Lambek.FSf a)))::((Sequent ((Lambek.FSf b),
          y2))::[])) hders0
      in
      let hders2 =
        forallT_inv_tail (Sequent (x, (Lambek.Gre ((Lambek.FSf a),
          (Lambek.FSf b))))) ((Sequent (y1, (Lambek.FSf a)))::((Sequent
          ((Lambek.FSf b), y2))::[])) hders0
      in
      let hders3 =
        forallT_inv (Sequent (y1, (Lambek.FSf a))) ((Sequent ((Lambek.FSf b),
          y2))::[]) hders2
      in
      let hders4 =
        forallT_inv_tail (Sequent (y1, (Lambek.FSf a))) ((Sequent
          ((Lambek.FSf b), y2))::[]) hders2
      in
      ...
      deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log lambek_log
        ...
        (seq_matchsub eqDec_formula f_Lambek_log lambek_log eqDec_structr
          f_Lambek lambek_str
          (conclRule eqDec_formula f_Lambek_log lambek_log eqDec_structr
            f_Lambek lambek_str LambekRules.coq_Rsmgel) (Sequent (x,
          (Lambek.Gre (y1, y2)))))
        (forallT_deriv_cofseqs eqDec_formula f_Lambek_log lambek_log
          eqDec_structr f_Lambek lambek_str lambek_DC
          (map
          ...
          ((seqSubst eqDec_formula f_Lambek_log lambek_log eqDec_structr
             ...
             (seq_matchsub eqDec_formula f_Lambek_log lambek_log
               ...
               (conclRule eqDec_formula f_Lambek_log lambek_log eqDec_structr
                 f_Lambek lambek_str LambekRules.coq_Rsmgel) (Sequent (x,
               (Lambek.Gre (y1, y2))))) (Sequent ((Lambek.Smc ((Lambek.SVf
             "X"), (Lambek.SVf "Y"))), (Lambek.SVf "Z")))), [],
          (deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log lambek_log
            eqDec_structr f_Lambek lambek_str lambek_DC
            (premsRule eqDec_formula f_Lambek_log lambek_log eqDec_structr
            ...
            (forallT_deriv_cofseqs eqDec_formula f_Lambek_log lambek_log
              ...
              (map
                (seqSubst eqDec_formula f_Lambek_log lambek_log eqDec_structr
                  ...
                  (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                    ...
                    (conclRule eqDec_formula f_Lambek_log lambek_log
                      eqDec_structr f_Lambek lambek_str
                      LambekRules.coq_Rlesmr) (Sequent ((Lambek.Smc (y1, x)),
                    y2))))
                (premsRule eqDec_formula f_Lambek_log lambek_log
              ...
              ((seqSubst eqDec_formula f_Lambek_log lambek_log eqDec_structr
                 ...
                 (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                   ...
                   (conclRule eqDec_formula f_Lambek_log lambek_log
                     eqDec_structr f_Lambek lambek_str LambekRules.coq_Rlesmr)
                   (Sequent ((Lambek.Smc (y1, x)), y2))) (Sequent
              ...
              (deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log
                ...
                (conclRule eqDec_formula f_Lambek_log lambek_log
                  ...
                  (cUT eqDec_formula f_Lambek_log lambek_log eqDec_structr
                    f_Lambek lambek_str))
                (cUT_spec eqDec_formula f_Lambek_log lambek_log eqDec_structr
                  f_Lambek lambek_str a y1 (Lambek.Les (y2, x)))
                (forallT_deriv_cofseqs eqDec_formula f_Lambek_log lambek_log
                  eqDec_structr f_Lambek lambek_str lambek_DC ((Sequent (y1,
                  (Lambek.FSf a)))::((Sequent ((Lambek.FSf a), (Lambek.Les
                  (y2, x))))::[])) (ForallT_cons ((Sequent (y1, (Lambek.FSf
                  a))), ((Sequent ((Lambek.FSf a), (Lambek.Les (y2,
                  x))))::[]), hders3, (ForallT_cons ((Sequent ((Lambek.FSf
                  a), (Lambek.Les (y2, x)))), [],
                  (deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log
                    lambek_log eqDec_structr f_Lambek lambek_str lambek_DC
                    (premsRule eqDec_formula f_Lambek_log lambek_log
                      ...
                      ((seqSubst eqDec_formula f_Lambek_log lambek_log
                         ...
                         (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                           ...
                           (conclRule eqDec_formula f_Lambek_log lambek_log
                             eqDec_structr f_Lambek lambek_str
                             LambekRules.coq_Rsmlel) (Sequent ((Lambek.FSf
                           a), (Lambek.Les (y2, x))))) (Sequent ((Lambek.Smc
                         ((Lambek.SVf "X"), (Lambek.SVf "Y"))), (Lambek.SVf
                         "Z")))), [],
                      (deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log
                        lambek_log eqDec_structr f_Lambek lambek_str
                        ...
                        (conclRule eqDec_formula f_Lambek_log lambek_log
                          ...
                          (cUT eqDec_formula f_Lambek_log lambek_log
                            eqDec_structr f_Lambek lambek_str))
                        (cUT_spec eqDec_formula f_Lambek_log lambek_log
                          eqDec_structr f_Lambek lambek_str b (Lambek.Smc
                          ((Lambek.FSf a), x)) y2)
                        (forallT_deriv_cofseqs eqDec_formula f_Lambek_log
                          lambek_log eqDec_structr f_Lambek lambek_str
                          lambek_DC ((Sequent ((Lambek.Smc ((Lambek.FSf a),
                          x)), (Lambek.FSf b)))::((Sequent ((Lambek.FSf b),
                          y2))::[])) (ForallT_cons ((Sequent ((Lambek.Smc
                              ...
                              (map
                                (seqSubst eqDec_formula f_Lambek_log
                                  ...
                                  (seq_matchsub eqDec_formula f_Lambek_log
                                    ...
                                    (Sequent ((Lambek.Smc ((Lambek.FSf a),
                                    x)), (Lambek.FSf b)))))
                                (premsRule eqDec_formula f_Lambek_log
                                  lambek_log eqDec_structr f_Lambek
                                  lambek_str LambekRules.coq_Rgesmr))
                              ...
                              ((seqSubst eqDec_formula f_Lambek_log
                                 ...
                                 (seq_matchsub eqDec_formula f_Lambek_log
                                   ...
                                   (conclRule eqDec_formula f_Lambek_log
                                     ...
                                     lambek_str LambekRules.coq_Rgesmr)
                                   (Sequent ((Lambek.Smc ((Lambek.FSf a),
                                   x)), (Lambek.FSf b)))) (Sequent
                                 ((Lambek.SVf "X"), (Lambek.Gre ((Lambek.SVf
                                 "Y"), (Lambek.SVf "Z")))))), [], hders1,
                              ForallT_nil)))), (ForallT_cons ((Sequent
                          ((Lambek.FSf b), y2)), [], hders5, ForallT_nil)))))),
                      ForallT_nil)))), ForallT_nil)))))), ForallT_nil)))),
          ForallT_nil)))) ld
  ...
  let coq_C8_Ove x y1 y2 a b ld =
    c8_case_alt_imp_C8_case eqDec_formula f_Lambek_log lambek_log
      eqDec_structr f_Lambek lambek_str lambek_DC x (Lambek.Les (y1, y2))
      ((Sequent (x, (Lambek.Les ((Lambek.FSf a), (Lambek.FSf
      ...
      in
      let hders1 =
        forallT_inv (Sequent (x, (Lambek.Les ((Lambek.FSf a), (Lambek.FSf
          b))))) ((Sequent ((Lambek.FSf a), y1))::((Sequent (y2, (Lambek.FSf
          b)))::[])) hders0
      in
      let hders2 =
        forallT_inv_tail (Sequent (x, (Lambek.Les ((Lambek.FSf a),
          (Lambek.FSf b))))) ((Sequent ((Lambek.FSf a), y1))::((Sequent (y2,
          (Lambek.FSf b)))::[])) hders0
      in
      let hders3 =
        forallT_inv (Sequent ((Lambek.FSf a), y1)) ((Sequent (y2, (Lambek.FSf
          b)))::[]) hders2
      in
      let hders4 =
        forallT_inv_tail (Sequent ((Lambek.FSf a), y1)) ((Sequent (y2,
          (Lambek.FSf b)))::[]) hders2
      in
      ...
      deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log lambek_log
        ...
        (seq_matchsub eqDec_formula f_Lambek_log lambek_log eqDec_structr
          f_Lambek lambek_str
          (conclRule eqDec_formula f_Lambek_log lambek_log eqDec_structr
            f_Lambek lambek_str LambekRules.coq_Rsmlel) (Sequent (x,
          (Lambek.Les (y1, y2)))))
        (forallT_deriv_cofseqs eqDec_formula f_Lambek_log lambek_log
          eqDec_structr f_Lambek lambek_str lambek_DC
          (map
          ...
          ((seqSubst eqDec_formula f_Lambek_log lambek_log eqDec_structr
             ...
             (seq_matchsub eqDec_formula f_Lambek_log lambek_log
               ...
               (conclRule eqDec_formula f_Lambek_log lambek_log eqDec_structr
                 f_Lambek lambek_str LambekRules.coq_Rsmlel) (Sequent (x,
               (Lambek.Les (y1, y2))))) (Sequent ((Lambek.Smc ((Lambek.SVf
             "X"), (Lambek.SVf "Y"))), (Lambek.SVf "Z")))), [],
          (deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log lambek_log
            eqDec_structr f_Lambek lambek_str lambek_DC
            (premsRule eqDec_formula f_Lambek_log lambek_log eqDec_structr
            ...
            (forallT_deriv_cofseqs eqDec_formula f_Lambek_log lambek_log
              ...
              (map
                (seqSubst eqDec_formula f_Lambek_log lambek_log eqDec_structr
                  ...
                  (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                    ...
                    (conclRule eqDec_formula f_Lambek_log lambek_log
                      eqDec_structr f_Lambek lambek_str
                      LambekRules.coq_Rgesmr) (Sequent ((Lambek.Smc (x, y2)),
                    y1))))
                (premsRule eqDec_formula f_Lambek_log lambek_log
                  eqDec_structr f_Lambek lambek_str LambekRules.coq_Rgesmr))
              (ForallT_cons
              ((seqSubst eqDec_formula f_Lambek_log lambek_log eqDec_structr
                 ...
                 (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                   ...
                   (conclRule eqDec_formula f_Lambek_log lambek_log
                     eqDec_structr f_Lambek lambek_str LambekRules.coq_Rgesmr)
                   (Sequent ((Lambek.Smc (x, y2)), y1))) (Sequent
              ...
              (deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log
                ...
                (conclRule eqDec_formula f_Lambek_log lambek_log
                  ...
                  (cUT eqDec_formula f_Lambek_log lambek_log eqDec_structr
                    f_Lambek lambek_str))
                (cUT_spec eqDec_formula f_Lambek_log lambek_log eqDec_structr
                  f_Lambek lambek_str b y2 (Lambek.Gre (x, y1)))
                (forallT_deriv_cofseqs eqDec_formula f_Lambek_log lambek_log
                  eqDec_structr f_Lambek lambek_str lambek_DC ((Sequent (y2,
                  (Lambek.FSf b)))::((Sequent ((Lambek.FSf b), (Lambek.Gre
                  (x, y1))))::[])) (ForallT_cons ((Sequent (y2, (Lambek.FSf
                  b))), ((Sequent ((Lambek.FSf b), (Lambek.Gre (x,
                  y1))))::[]), hders5, (ForallT_cons ((Sequent ((Lambek.FSf
                  b), (Lambek.Gre (x, y1)))), [],
                  (deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log
                    lambek_log eqDec_structr f_Lambek lambek_str lambek_DC
                    (premsRule eqDec_formula f_Lambek_log lambek_log
                      eqDec_structr f_Lambek lambek_str
                      LambekRules.coq_Rsmgel)
                    (conclRule eqDec_formula f_Lambek_log lambek_log
                      eqDec_structr f_Lambek lambek_str
                      LambekRules.coq_Rsmgel)
                    (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                      ...
                      (map
                        (seqSubst eqDec_formula f_Lambek_log lambek_log
                          ...
                          (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                            ...
                            (conclRule eqDec_formula f_Lambek_log lambek_log
                              eqDec_structr f_Lambek lambek_str
                              LambekRules.coq_Rsmgel) (Sequent ((Lambek.FSf
                            b), (Lambek.Gre (x, y1))))))
                        (premsRule eqDec_formula f_Lambek_log lambek_log
                          eqDec_structr f_Lambek lambek_str
                          LambekRules.coq_Rsmgel)) (ForallT_cons
                      ((seqSubst eqDec_formula f_Lambek_log lambek_log
                         ...
                         (seq_matchsub eqDec_formula f_Lambek_log lambek_log
                           ...
                           (conclRule eqDec_formula f_Lambek_log lambek_log
                             eqDec_structr f_Lambek lambek_str
                             LambekRules.coq_Rsmgel) (Sequent ((Lambek.FSf
                           b), (Lambek.Gre (x, y1))))) (Sequent ((Lambek.Smc
                         ((Lambek.SVf "X"), (Lambek.SVf "Y"))), (Lambek.SVf
                         "Z")))), [],
                      (deriv_cofseq_rule_bw_inDC eqDec_formula f_Lambek_log
                        lambek_log eqDec_structr f_Lambek lambek_str
                        ...
                        (conclRule eqDec_formula f_Lambek_log lambek_log
                          ...
                          (cUT eqDec_formula f_Lambek_log lambek_log
                            eqDec_structr f_Lambek lambek_str))
                        (cUT_spec eqDec_formula f_Lambek_log lambek_log
                          eqDec_structr f_Lambek lambek_str a (Lambek.Smc (x,
                          (Lambek.FSf b))) y1)
                        (forallT_deriv_cofseqs eqDec_formula f_Lambek_log
                          lambek_log eqDec_structr f_Lambek lambek_str
                          lambek_DC ((Sequent ((Lambek.Smc (x, (Lambek.FSf
                          b))), (Lambek.FSf a)))::((Sequent ((Lambek.FSf a),
                          y1))::[])) (ForallT_cons ((Sequent ((Lambek.Smc (x,
                              ...
                              (map
                                (seqSubst eqDec_formula f_Lambek_log
                                  ...
                                  (seq_matchsub eqDec_formula f_Lambek_log
                                    ...
                                    (Sequent ((Lambek.Smc (x, (Lambek.FSf
                                    b))), (Lambek.FSf a)))))
                                (premsRule eqDec_formula f_Lambek_log
                                  lambek_log eqDec_structr f_Lambek
                                  lambek_str LambekRules.coq_Rlesmr))
                              ...
                              ((seqSubst eqDec_formula f_Lambek_log
                                 ...
                                 (seq_matchsub eqDec_formula f_Lambek_log
                                   ...
                                   (conclRule eqDec_formula f_Lambek_log
                                     ...
                                     lambek_str LambekRules.coq_Rlesmr)
                                   (Sequent ((Lambek.Smc (x, (Lambek.FSf
                                   b))), (Lambek.FSf a)))) (Sequent
                                 ((Lambek.SVf "X"), (Lambek.Les ((Lambek.SVf
                                 "Y"), (Lambek.SVf "Z")))))), [], hders1,
                              ForallT_nil)))), (ForallT_cons ((Sequent
                          ((Lambek.FSf a), y1)), [], hders3, ForallT_nil)))))),
                      ForallT_nil)))), ForallT_nil)))))), ForallT_nil)))),
          ForallT_nil)))) ld
  ...
  let coq_C8_holds m dt =
    reduce_C8 eqDec_formula f_Lambek_log lambek_log eqDec_structr f_Lambek
      lambek_str lambek_DC (fun a _ x y rL lL rR lR _ _ _ _ _ _ _ _ ->
      eq_dec_in_list
        (eqdec
        ...
        (atrefl eqDec_formula f_Lambek_log lambek_log eqDec_structr f_Lambek
          lambek_str)
        (LambekRules.coq_Topr::(LambekRules.coq_Botr::(LambekRules.coq_Conr::(LambekRules.coq_Disrl::(LambekRules.coq_Disrr::(LambekRules.coq_Oner::(LambekRules.coq_Fusr::(LambekRules.coq_Undr::(LambekRules.coq_Over::[])))))))))
        rL (fun _ ->
        eq_dec_in_list
          (eqdec
            (eqDec_rule eqDec_formula f_Lambek_log lambek_log eqDec_structr
          ...
          (atrefl eqDec_formula f_Lambek_log lambek_log eqDec_structr
            f_Lambek lambek_str)
          (LambekRules.coq_Topl::(LambekRules.coq_Botl::(LambekRules.coq_Conll::(LambekRules.coq_Conlr::(LambekRules.coq_Disl::(LambekRules.coq_Onel::(LambekRules.coq_Fusl::(LambekRules.coq_Undl::(LambekRules.coq_Ovel::[])))))))))
          rR (fun _ ->
          let hwfrR =
            ruleInst_ruleSubst eqDec_formula f_Lambek_log lambek_log
              eqDec_structr f_Lambek lambek_str rR
              ((map
                 (conclDT eqDec_formula f_Lambek_log lambek_log eqDec_structr
                   f_Lambek lambek_str) lR),(Sequent ((lambek_str.fS a), y)))
          in
          (match lL with
           | [] ->
             (match lR with
              | [] ->
                ...
                Der ((Sequent ((Lambek.FSf (Lambek.Atf p)), (Lambek.FSf
                (Lambek.Atf p)))),
                (atrefl eqDec_formula f_Lambek_log lambek_log eqDec_structr
                  f_Lambek lambek_str), [])
              | _::_ -> assert false (* absurd case *))
          ...
          eq_dec_in_list
            ...
            (LambekRules.coq_Botl::(LambekRules.coq_Conll::(LambekRules.coq_Conlr::(LambekRules.coq_Disl::(LambekRules.coq_Onel::(LambekRules.coq_Fusl::(LambekRules.coq_Undl::(LambekRules.coq_Ovel::[]))))))))
            ...
            eq_dec_in_list
              ...
              (LambekRules.coq_Conll::(LambekRules.coq_Conlr::(LambekRules.coq_Disl::(LambekRules.coq_Onel::(LambekRules.coq_Fusl::(LambekRules.coq_Undl::(LambekRules.coq_Ovel::[])))))))
              rR (fun _ -> assert false (* absurd case *)) (fun _ ->
              eq_dec_in_list
                (eqdec
                  (eqDec_rule eqDec_formula f_Lambek_log lambek_log
                    eqDec_structr f_Lambek lambek_str)) LambekRules.coq_Conll
                (LambekRules.coq_Conlr::(LambekRules.coq_Disl::(LambekRules.coq_Onel::(LambekRules.coq_Fusl::(LambekRules.coq_Undl::(LambekRules.coq_Ovel::[]))))))
                rR (fun _ -> assert false (* absurd case *)) (fun _ ->
                eq_dec_in_list
                  (eqdec
                    (eqDec_rule eqDec_formula f_Lambek_log lambek_log
                  ...
                  (LambekRules.coq_Disl::(LambekRules.coq_Onel::(LambekRules.coq_Fusl::(LambekRules.coq_Undl::(LambekRules.coq_Ovel::[])))))
                  rR (fun _ -> assert false (* absurd case *)) (fun _ ->
                  eq_dec_in_list
                    (eqdec
                      (eqDec_rule eqDec_formula f_Lambek_log lambek_log
                    ...
                    (LambekRules.coq_Onel::(LambekRules.coq_Fusl::(LambekRules.coq_Undl::(LambekRules.coq_Ovel::[]))))
                    rR (fun _ -> assert false (* absurd case *)) (fun _ ->
                    eq_dec_in_list
                      (eqdec
                        (eqDec_rule eqDec_formula f_Lambek_log lambek_log
        ...
        eq_dec_in_list
          (eqdec
            (eqDec_rule eqDec_formula f_Lambek_log lambek_log eqDec_structr
              f_Lambek lambek_str)) LambekRules.coq_Topr
          (LambekRules.coq_Botr::(LambekRules.coq_Conr::(LambekRules.coq_Disrl::(LambekRules.coq_Disrr::(LambekRules.coq_Oner::(LambekRules.coq_Fusr::(LambekRules.coq_Undr::(LambekRules.coq_Over::[]))))))))
          rL (fun _ ->
          eq_dec_in_list
            (eqdec
              (eqDec_rule eqDec_formula f_Lambek_log lambek_log eqDec_structr
          ...
          eq_dec_in_list
            (eqdec
              (eqDec_rule eqDec_formula f_Lambek_log lambek_log eqDec_structr
                f_Lambek lambek_str)) LambekRules.coq_Botr
            (LambekRules.coq_Conr::(LambekRules.coq_Disrl::(LambekRules.coq_Disrr::(LambekRules.coq_Oner::(LambekRules.coq_Fusr::(LambekRules.coq_Undr::(LambekRules.coq_Over::[])))))))
            rL (fun _ ->
            eq_dec_in_list
              (eqdec
                (eqDec_rule eqDec_formula f_Lambek_log lambek_log
            ...
            eq_dec_in_list
              (eqdec
                (eqDec_rule eqDec_formula f_Lambek_log lambek_log
                  eqDec_structr f_Lambek lambek_str)) LambekRules.coq_Conr
              (LambekRules.coq_Disrl::(LambekRules.coq_Disrr::(LambekRules.coq_Oner::(LambekRules.coq_Fusr::(LambekRules.coq_Undr::(LambekRules.coq_Over::[]))))))
              rL (fun _ ->
              eq_dec_in_list
                (eqdec
                  (eqDec_rule eqDec_formula f_Lambek_log lambek_log
              ...
              eq_dec_in_list
                (eqdec
                  (eqDec_rule eqDec_formula f_Lambek_log lambek_log
                    eqDec_structr f_Lambek lambek_str)) LambekRules.coq_Disrl
                (LambekRules.coq_Disrr::(LambekRules.coq_Oner::(LambekRules.coq_Fusr::(LambekRules.coq_Undr::(LambekRules.coq_Over::[])))))
                rL (fun _ ->
                eq_dec_in_list
                  (eqdec
                    (eqDec_rule eqDec_formula f_Lambek_log lambek_log
                ...
                eq_dec_in_list
                  (eqdec
                    (eqDec_rule eqDec_formula f_Lambek_log lambek_log
                      eqDec_structr f_Lambek lambek_str))
                  LambekRules.coq_Disrr
                  (LambekRules.coq_Oner::(LambekRules.coq_Fusr::(LambekRules.coq_Undr::(LambekRules.coq_Over::[]))))
                  rL (fun _ ->
                  eq_dec_in_list
                    (eqdec
                      (eqDec_rule eqDec_formula f_Lambek_log lambek_log
                  ...
                  eq_dec_in_list
                          ...
                          eq_dec_in_list
                            ...
                            eq_dec_in_list
                              (eqdec
                                (eqDec_rule eqDec_formula f_Lambek_log
                                  lambek_log eqDec_structr f_Lambek
                                  lambek_str)) LambekRules.coq_Conlr
                              (LambekRules.coq_Disl::(LambekRules.coq_Onel::(LambekRules.coq_Fusl::(LambekRules.coq_Undl::(LambekRules.coq_Ovel::[])))))
                              rR (fun _ -> assert false (* absurd case *))
                              (fun _ ->
                              eq_dec_in_list
                    ...
                    eq_dec_in_list
                      (eqdec
                        (eqDec_rule eqDec_formula f_Lambek_log lambek_log
                          eqDec_structr f_Lambek lambek_str))
                      LambekRules.coq_Fusr
                      (LambekRules.coq_Undr::(LambekRules.coq_Over::[])) rL
                      (fun _ ->
                      eq_dec_in_list
                        (eqdec
                          (eqDec_rule eqDec_formula f_Lambek_log lambek_log
                          ...
                          eq_dec_in_list
                            ...
                            eq_dec_in_list
                              (eqdec
                                (eqDec_rule eqDec_formula f_Lambek_log
                                  lambek_log eqDec_structr f_Lambek
                                  lambek_str)) LambekRules.coq_Conll
                              (LambekRules.coq_Conlr::(LambekRules.coq_Disl::(LambekRules.coq_Onel::(LambekRules.coq_Fusl::(LambekRules.coq_Undl::(LambekRules.coq_Ovel::[]))))))
                              rR (fun _ -> assert false (* absurd case *))
                              (fun _ ->
                              eq_dec_in_list
                          ...
                          eq_dec_in_list
                            ...
                            eq_dec_in_list
                              (eqdec
                                (eqDec_rule eqDec_formula f_Lambek_log
                                  lambek_log eqDec_structr f_Lambek
                                  lambek_str)) LambekRules.coq_Botl
                              (LambekRules.coq_Conll::(LambekRules.coq_Conlr::(LambekRules.coq_Disl::(LambekRules.coq_Onel::(LambekRules.coq_Fusl::(LambekRules.coq_Undl::(LambekRules.coq_Ovel::[])))))))
                              rR (fun _ -> assert false (* absurd case *))
                              (fun _ ->
                              eq_dec_in_list
                                        ...
                                        eq_dec_in_list
                                          ...
                                          eq_dec_in_list
                                            ...
                                            eq_dec_in_list
                                              ...
                                              let hwfrL =
                                                ruleInst_ruleSubst
                                                  eqDec_formula f_Lambek_log
                                                  lambek_log eqDec_structr
...
let lambek_cutElim dt =
  cutElim eqDec_formula f_Lambek_log lambek_log eqDec_structr f_Lambek
    lambek_str lambek_DC lambek_DCBel dt
...
let derr_ex_rule =
  ...
  Der ((Sequent ((Lambek.FSf (Lambek.Fus ((Lambek.Ove (p, q)), q))),
  (Lambek.FSf (Lambek.Und ((Lambek.Ove (q, p)), q))))),
  (cUT eqDec_formula f_Lambek_log lambek_log eqDec_structr f_Lambek
    lambek_str), ((Der ((Sequent ((Lambek.FSf (Lambek.Fus ((Lambek.Ove (p,
  q)), q))), (Lambek.FSf p))), LambekRules.coq_Fusl, ((Der ((Sequent
  ((Lambek.Smc ((Lambek.FSf (Lambek.Ove (p, q))), (Lambek.FSf q))),
  (Lambek.FSf p))), LambekRules.coq_Rlesmr, ((Der ((Sequent ((Lambek.FSf
  (Lambek.Ove (p, q))), (Lambek.Les ((Lambek.FSf p), (Lambek.FSf q))))),
  LambekRules.coq_Ovel, ((Der ((Sequent ((Lambek.FSf p), (Lambek.FSf p))),
  (atrefl eqDec_formula f_Lambek_log lambek_log eqDec_structr f_Lambek
    lambek_str), []))::((Der ((Sequent ((Lambek.FSf q), (Lambek.FSf q))),
  (atrefl eqDec_formula f_Lambek_log lambek_log eqDec_structr f_Lambek
    lambek_str), []))::[]))))::[])))::[])))::((Der ((Sequent ((Lambek.FSf p),
  (Lambek.FSf (Lambek.Und ((Lambek.Ove (q, p)), q))))), LambekRules.coq_Undr,
  ((Der ((Sequent ((Lambek.FSf p), (Lambek.Gre ((Lambek.FSf (Lambek.Ove (q,
  p))), (Lambek.FSf q))))), LambekRules.coq_Rsmgel, ((Der ((Sequent
  ((Lambek.Smc ((Lambek.FSf (Lambek.Ove (q, p))), (Lambek.FSf p))),
  (Lambek.FSf q))), LambekRules.coq_Rlesmr, ((Der ((Sequent ((Lambek.FSf
  (Lambek.Ove (q, p))), (Lambek.Les ((Lambek.FSf q), (Lambek.FSf p))))),
  LambekRules.coq_Ovel, ((Der ((Sequent ((Lambek.FSf q), (Lambek.FSf q))),
  (atrefl eqDec_formula f_Lambek_log lambek_log eqDec_structr f_Lambek
    lambek_str), []))::((Der ((Sequent ((Lambek.FSf p), (Lambek.FSf p))),
  (atrefl eqDec_formula f_Lambek_log lambek_log eqDec_structr f_Lambek
    lambek_str), []))::[]))))::[])))::[])))::[])))::[])))
